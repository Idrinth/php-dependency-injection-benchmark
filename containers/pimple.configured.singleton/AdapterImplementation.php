...
class AdapterImplementation
{
    ...
    public function __construct()
    {
        ...
        $definitions = [
            ...
            B06::class => [A06::class],
            A06::class => [],
            P16::class => [O16::class, N16::class, M16::class, L16::class],
            O16::class => [N16::class, M16::class, L16::class, K16::class],
            N16::class => [M16::class, L16::class, K16::class, J16::class],
            M16::class => [L16::class, K16::class, J16::class, I16::class],
            L16::class => [K16::class, J16::class, I16::class, H16::class],
            K16::class => [J16::class, I16::class, H16::class, G16::class],
            J16::class => [I16::class, H16::class, G16::class, F16::class],
            I16::class => [H16::class, G16::class, F16::class, E16::class],
            H16::class => [G16::class, F16::class, E16::class, D16::class],
            G16::class => [F16::class, E16::class, D16::class, C16::class],
            F16::class => [E16::class, D16::class, C16::class, B16::class],
            E16::class => [D16::class, C16::class, B16::class, A16::class],
            D16::class => [C16::class, B16::class, A16::class],
            C16::class => [B16::class, A16::class],
            B16::class => [A16::class],
            A16::class => [],
        ...
        foreach ($definitions as $class => $deps) {
            $c[$class] = function ($c) use ($class, $deps) {
                $args = [];
                foreach ($deps as $dep) {
                    $args[] = $c[$dep];
                }
            ...
            $c[$iface] = function ($c) use ($impl, $ifaceDeps) {
                $args = [];
